...
let naturals = failwith "Not implemented"

// Задание 2 (1 балл). Без использования функций из модуля Seq, условного
// оператора и сопоставления с образцом получить последовательность
// 0, 1, 0, 2, 0, 3, ... (нечетные элементы - нули, четные - последовательность
// натуральных чисел).
let oddNaturals = failwith "Not implemented"

// Задание 3 (1 балл). Без использования модуля Seq реализовать функцию
// Seq.initInfinite.
let seqInitInfinite initializer = failwith "Not implemented"
